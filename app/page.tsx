...
const WAYS_TO_JOIN = [
  ...
  { title: 'Join Our Telegram', desc: 'Connect with the community, share prayer requests, and stay updated.', icon: '✈️', href: 'https://t.me/+GAtdULDkDcRhYjRh' },
]
            ...
            {WAYS_TO_JOIN.map((item) => {
              ...
              return item.href ? (
                <a
                  ...
                  className="rounded-2xl border border-ocean-100 p-8 text-left transition hover:border-ocean-300 hover:shadow-md block"
                >
                  {cardContent}
                </a>
              ) : (
